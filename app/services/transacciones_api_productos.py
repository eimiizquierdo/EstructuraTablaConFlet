...
# Ejecutar
# Ejecuta el proyecto del backend (proyecto inventario) con uvicorn app.main:app --reload

# Descomenta la siguiente línea antes de ejecutar, deberia mostrar los datos del backend
# print(list_products())
